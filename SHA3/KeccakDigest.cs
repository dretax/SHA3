...
namespace SHA3
{
    ...
    {
        private readonly ulong[] KeccakRoundConstants = KeccakInitializeRoundConstants();
        private readonly int[] KeccakRhoOffsets = KeccakInitializeRhoOffsets();
        ...
        public KeccakDigest(int bitLength)
        {
            switch (bitLength)
            {
                ...
                case 512:
                    ...
                    break;
                default:
                    throw new ArgumentException("must be 128, 224, 256, 288, 384, or 512.", "bitLength");
            }
        }
        ...
        private void Iota(ulong[] A, int indexRound)
        {
